...
def save_model_history(history, history_path):    
    ...
    with open(history_path+"/Bicephalus_AD_1365_margin_pat2_1_12_06_21_sagittal.pkl", 'wb') as handle:
...
def fit_generator(model, training_generator, validation_generator, checkpoint_path):    
    ...
    mc = tf.keras.callbacks.ModelCheckpoint('/media/iitindmaths/Seagate_Expansion_Drive/Bup_Backup/SPM/alzheimers-disease/CN_vs_AD/model_checkpoints/Bicephalus_AD_1365_margin_pat2_1_12_06_21_sagittal_{epoch:08d}.h5', 
...
datapath = '/media/iitindmaths/Seagate_Expansion_Drive/Bup_Backup/SPM/alzheimers-disease/CN_vs_AD/npy_large/smwp1_sagittal'
...
cv_file = '/media/iitindmaths/Seagate_Expansion_Drive/Alz_CN_vs_AD_1365_each_full_subject_list_sagittal.pkl'
